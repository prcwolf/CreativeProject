...
//        }
        ...
        c.drawText("process time is " + processTime, 10, 20, paint);
        paint.setColor(0xff000000 | (idealR << 020) | (idealG << 010) | idealB);
        c.drawRect(10, 30, 60, 80, paint);
        paint.setColor(0xff000000 | (idealR << 020));
        c.drawRect(60, 30, 110,  80, paint);
        paint.setColor(0xff000000 | (idealG << 010));
        c.drawRect(10, 80,  60, 130, paint);
        paint.setColor(0xff000000 | idealB);
        c.drawRect(60, 80, 110, 130, paint);
